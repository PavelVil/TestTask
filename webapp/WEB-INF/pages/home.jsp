...
<c:forEach items="${listUsers}" var="user">
    <div class="col-md-3">
        <div class="panel block-profile">
            <div style="background-image: url('http://bootstraptema.ru/images/bg/bg-4.png')"
            ...
            <div class="list-group">
                ...
                <form action="/uploadPhoto" method="post" enctype="multipart/form-data"
                      class="form-inline list-group-item-form">
                    <input type="hidden" name="id" value="${user.id}">
                    <div class="form-group">
                        <input type="file" id="photo-from-list-${user.id}" name="photo" accept="image/png"
                               class="btn-default">
